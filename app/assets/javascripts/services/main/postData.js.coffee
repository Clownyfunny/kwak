angular.module('Kwak').factory('postData', ['$http', ($http) ->

  postData =
    data:
      posts: [{title: 'Loading', description: ''}]
    isLoaded: false
  ...
  postData.createPost = (newPost) ->
    ...
    if newPost.newPostTitle == '' or newPost.newPostDescription == ''
    ...
    data =
      new_post:
        ...
        description: newPost.newPostDescription
